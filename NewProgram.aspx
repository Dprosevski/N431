...
<body id="page-top">
    ...
    <form id="form1" runat="server">
        ...
        <asp:RequiredFieldValidator ID="proContactControl" runat="server" ForeColor="Red" ErrorMessage="required Field" Display="Dynamic" ControlToValidate="proContact">*Required</asp:RequiredFieldValidator><br />
        <br />
        ...
        <asp:RequiredFieldValidator ID="proContactControlEmail" runat="server" ForeColor="Red" ErrorMessage="required Field" Display="Dynamic" ControlToValidate="proContactEmail">*Required</asp:RequiredFieldValidator><br />
        <br />
        ...
        <asp:RequiredFieldValidator ID="proContactControlPhone" runat="server" ForeColor="Red" ErrorMessage="required Field" Display="Dynamic" ControlToValidate="proContactPhone">*Required</asp:RequiredFieldValidator><br />
        <br />
        ...
        <asp:TextBox ID="other" runat="server" BackColor="White" onfocus="this.select()" Visible="true"></asp:TextBox><br />
        <br />
        ...
        <asp:TextBox ID="stipendinput1" runat="server" BackColor="White" onfocus="this.select()" Visible="true"></asp:TextBox><br />
        <br />
        ...
        <asp:TextBox ID="stipendinput2" runat="server" BackColor="White" onfocus="this.select()" Visible="true"></asp:TextBox><br />
        <br />
        ...
        <asp:RequiredFieldValidator ID="StartDateControl" runat="server" ForeColor="Red" ErrorMessage="required Field" Display="Dynamic" ControlToValidate="StartDate">*Required</asp:RequiredFieldValidator><br />
        <br />
        ...
        <asp:RequiredFieldValidator ID="AppDeadlineControl" runat="server" ForeColor="Red" ErrorMessage="required Field" Display="Dynamic" ControlToValidate="AppDeadline">*Required</asp:RequiredFieldValidator><br />
        <br />
